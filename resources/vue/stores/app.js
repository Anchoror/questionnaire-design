...
export const appStore = defineStore('app',()=> {
    ...
    const listItemId = ref(0) //当前最新的组件 id
    ...
    const formMap = shallowRef({
        radio: defineAsyncComponent(() => import('@/components/form/radioForm.vue')),
        check: defineAsyncComponent(() => import('@/components/form/checkForm.vue')),
        input: defineAsyncComponent(() => import('@/components/form/inputForm.vue')),
        select: defineAsyncComponent(() => import('@/components/form/selectForm.vue')),
        date: defineAsyncComponent(() => import('@/components/form/dateForm.vue')),
        color: defineAsyncComponent(() => import('@/components/form/colorForm.vue')),
        switch: defineAsyncComponent(() => import('@/components/form/switchForm.vue')),
        slider: defineAsyncComponent(() => import('@/components/form/sliderForm.vue')),
        ...
        button: defineAsyncComponent(() => import('@/components/other/btn.vue')),
        text: defineAsyncComponent(() => import('@/components/other/txt.vue')),
    })

    return {
        activeId, listItemId, baseConfig, typeConfigMap, formConfig, formModel, componentMap, otherMap, formMap
    }
},{
    persist: {
      paths: [],
